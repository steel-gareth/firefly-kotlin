...
package com.firefly.api.core.http

import com.firefly.api.core.DefaultSleeper
import com.firefly.api.core.RequestOptions
import com.firefly.api.core.Sleeper
import com.firefly.api.core.checkRequired
import com.firefly.api.errors.FireflyIoException
import com.firefly.api.errors.FireflyRetryableException
...
private constructor(
    ...
    private fun shouldRetry(throwable: Throwable): Boolean =
        ...
        throwable is IOException ||
            throwable is FireflyIoException ||
            throwable is FireflyRetryableException
