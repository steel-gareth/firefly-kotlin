...
import com.configure_me_emcees_prod_testing_5.api.core.BaseDeserializer
import com.configure_me_emcees_prod_testing_5.api.core.BaseSerializer
...
import com.configure_me_emcees_prod_testing_5.api.core.allMaxBy
import com.configure_me_emcees_prod_testing_5.api.core.getOrThrow
...
private constructor(
     ...
     * ```
     *
     * @throws EmceesProdTesting5InvalidDataException if [Visitor.unknown] is not overridden in
    ...
    interface Visitor<out T> {
         ...
         * is unaware of.
         *
         * @throws EmceesProdTesting5InvalidDataException in the default implementation.
         */
        fun unknown(json: JsonValue?): T {
            throw EmceesProdTesting5InvalidDataException("Unknown PolymorphicProperty: $json")
        }
    }
