...
class IncomeListByCategoryParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IncomeListByCategoryParams].
         *
    ...
    /** A builder for [IncomeListByCategoryParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomeListByCategoryParams: IncomeListByCategoryParams) = apply {
            end = incomeListByCategoryParams.end
            start = incomeListByCategoryParams.start
            accounts = incomeListByCategoryParams.accounts?.toMutableList()
            categories = incomeListByCategoryParams.categories?.toMutableList()
            xTraceId = incomeListByCategoryParams.xTraceId
            additionalHeaders = incomeListByCategoryParams.additionalHeaders.toBuilder()
            additionalQueryParams = incomeListByCategoryParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IncomeListByCategoryParams].
         *
         ...
         */
        fun build(): IncomeListByCategoryParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeListByCategoryParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "IncomeListByCategoryParams{end=$end, start=$start, accounts=$accounts, categories=$categories, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
