 ...
 */
class AvailableBudgetServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    AvailableBudgetService {

    private val withRawResponse: AvailableBudgetService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): AvailableBudgetService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): AvailableBudgetService =
        AvailableBudgetServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            AvailableBudgetServiceImpl.WithRawResponseImpl(
