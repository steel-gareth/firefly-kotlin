 ...
 */
class RecurrenceServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    RecurrenceService {

    private val withRawResponse: RecurrenceService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): RecurrenceService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): RecurrenceService =
        RecurrenceServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun delete(params: RecurrenceDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            RecurrenceServiceImpl.WithRawResponseImpl(
