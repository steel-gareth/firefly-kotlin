 ...
 */
class ExpenseServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ExpenseServiceAsync {

    private val withRawResponse: ExpenseServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): ExpenseServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): ExpenseServiceAsync =
        ExpenseServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun listByBill(
    ...
    override suspend fun listByBudget(
    ...
    override suspend fun listByExpenseAccount(
    ...
    override suspend fun listWithoutBill(
    ...
    override suspend fun listWithoutBudget(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            ExpenseServiceAsyncImpl.WithRawResponseImpl(
