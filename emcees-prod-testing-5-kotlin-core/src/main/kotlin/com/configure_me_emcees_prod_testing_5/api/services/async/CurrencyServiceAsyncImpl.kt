...
import com.configure_me_emcees_prod_testing_5.api.models.currencies.CurrencyListResponse
...
import com.configure_me_emcees_prod_testing_5.api.services.async.currencies.PrimaryServiceAsync
import com.configure_me_emcees_prod_testing_5.api.services.async.currencies.PrimaryServiceAsyncImpl
...
class CurrencyServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val primary: PrimaryServiceAsync by lazy { PrimaryServiceAsyncImpl(clientOptions) }

    override fun withRawResponse(): CurrencyServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CurrencyServiceAsync =
        CurrencyServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
     ...
     */
    override fun primary(): PrimaryServiceAsync = primary
    ...
    override suspend fun delete(params: CurrencyDeleteParams, requestOptions: RequestOptions) {
    ...
    override suspend fun listAvailableBudgets(
    ...
    override suspend fun listBudgetLimits(
    ...
    override suspend fun listRecurrences(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val primary: PrimaryServiceAsync.WithRawResponse by lazy {
            PrimaryServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }
         ...
         */
        override fun primary(): PrimaryServiceAsync.WithRawResponse = primary
