...
import com.configure_me_emcees_prod_testing_5.api.client.EmceesProdTesting5ClientAsyncImpl
...
/**
 * A class that allows building an instance of [EmceesProdTesting5ClientAsync] with [OkHttpClient]
 * as the underlying [HttpClient].
 */
class EmceesProdTesting5OkHttpClientAsync private constructor() {
    ...
    companion object {
         ...
         */
        fun fromEnv(): EmceesProdTesting5ClientAsync = builder().fromEnv().build()
    }

    /** A builder for [EmceesProdTesting5OkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EmceesProdTesting5ClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmceesProdTesting5ClientAsync =
            EmceesProdTesting5ClientAsyncImpl(
                clientOptions
                    .httpClient(
