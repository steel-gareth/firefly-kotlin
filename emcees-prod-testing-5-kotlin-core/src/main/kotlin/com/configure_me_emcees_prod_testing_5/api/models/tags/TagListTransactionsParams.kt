...
class TagListTransactionsParams
private constructor(
    ...
    companion object {
        ...
        fun none(): TagListTransactionsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TagListTransactionsParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [TagListTransactionsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(tagListTransactionsParams: TagListTransactionsParams) = apply {
            tag = tagListTransactionsParams.tag
            end = tagListTransactionsParams.end
            limit = tagListTransactionsParams.limit
            page = tagListTransactionsParams.page
            start = tagListTransactionsParams.start
            type = tagListTransactionsParams.type
            xTraceId = tagListTransactionsParams.xTraceId
            additionalHeaders = tagListTransactionsParams.additionalHeaders.toBuilder()
            additionalQueryParams = tagListTransactionsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TagListTransactionsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TagListTransactionsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TagListTransactionsParams &&
            tag == other.tag &&
            end == other.end &&
            limit == other.limit &&
            page == other.page &&
    ...
    override fun toString() =
        "TagListTransactionsParams{tag=$tag, end=$end, limit=$limit, page=$page, start=$start, type=$type, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
