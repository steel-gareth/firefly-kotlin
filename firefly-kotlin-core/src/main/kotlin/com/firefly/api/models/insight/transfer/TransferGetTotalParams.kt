...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransferGetTotalParams].
         *
    ...
    /** A builder for [TransferGetTotalParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(transferGetTotalParams: TransferGetTotalParams) = apply {
            end = transferGetTotalParams.end
            start = transferGetTotalParams.start
            accounts = transferGetTotalParams.accounts?.toMutableList()
            xTraceId = transferGetTotalParams.xTraceId
            additionalHeaders = transferGetTotalParams.additionalHeaders.toBuilder()
            additionalQueryParams = transferGetTotalParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransferGetTotalParams].
         *
         ...
         */
        fun build(): TransferGetTotalParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferGetTotalParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "TransferGetTotalParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
