...
private constructor(
    private val data: JsonField<List<TagRead>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<TagRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<TagRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<TagRead>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<TagRead>>? = null
        ...
        internal fun from(tagListResponse: TagListResponse) = apply {
            data = tagListResponse.data.map { it.toMutableList() }
            links = tagListResponse.links
            meta = tagListResponse.meta
            additionalProperties = tagListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<TagRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TagRead>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<TagRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TagRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TagRead) = apply {
            this.data =
    ...
    override fun toString() =
        "TagListResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
