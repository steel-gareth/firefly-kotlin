...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = LiabilityDirectionProperty(JsonField.of(value))
    }

    /** An enum containing [LiabilityDirectionProperty]'s known values. */
    enum class Known {
        CREDIT,
        DEBIT,
    }
    ...
    /**
     * An enum containing [LiabilityDirectionProperty]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [LiabilityDirectionProperty] can contain an unknown value in a couple of
     * cases:
    ...
    enum class Value {
        ...
        DEBIT,
        /**
         * An enum member indicating that [LiabilityDirectionProperty] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
        ...
        when (this) {
            ...
            DEBIT -> Known.DEBIT
                ...
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown LiabilityDirectionProperty: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): LiabilityDirectionProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LiabilityDirectionProperty && value == other.value
    }
