 ...
 * tag.
 */
class TransferListWithoutTagParams
private constructor(
     ...
     * liabilities, only transfers from those asset accounts / liabilities will be included. Other
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransferListWithoutTagParams].
         *
    ...
    /** A builder for [TransferListWithoutTagParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(transferListWithoutTagParams: TransferListWithoutTagParams) = apply {
            end = transferListWithoutTagParams.end
            start = transferListWithoutTagParams.start
            accounts = transferListWithoutTagParams.accounts?.toMutableList()
            xTraceId = transferListWithoutTagParams.xTraceId
            additionalHeaders = transferListWithoutTagParams.additionalHeaders.toBuilder()
            additionalQueryParams = transferListWithoutTagParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * The accounts to be included in the results. If you include ID's of asset accounts or
         * liabilities, only transfers from those asset accounts / liabilities will be included.
        ...
        /**
         * Returns an immutable instance of [TransferListWithoutTagParams].
         *
         ...
         */
        fun build(): TransferListWithoutTagParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferListWithoutTagParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "TransferListWithoutTagParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
