...
internal class AccountReadTest {
    ...
    fun create() {
        ...
        assertThat(accountRead.id()).isEqualTo("2")
        assertThat(accountRead.attributes())
            .isEqualTo(
                AccountRead.Attributes.builder()
                    .name("My checking account")
                    .type(ShortAccountTypeProperty.ASSET)
        ...
        assertThat(accountRead.type()).isEqualTo("accounts")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedAccountRead =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(accountRead),
                jacksonTypeRef<AccountRead>(),
            )

        assertThat(roundtrippedAccountRead).isEqualTo(accountRead)
    }
}
