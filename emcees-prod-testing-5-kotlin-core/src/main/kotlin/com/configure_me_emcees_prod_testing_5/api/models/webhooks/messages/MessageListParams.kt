...
/**
 * When a webhook is triggered the actual message that will be send is stored in a "message". You
 * can view and analyse these messages.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(messageListParams: MessageListParams) = apply {
            id = messageListParams.id
            xTraceId = messageListParams.xTraceId
    ...
    override fun toString() =
        "MessageListParams{id=$id, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
