...
class CurrencyListAccountsParams
private constructor(
    ...
    companion object {
        ...
        fun none(): CurrencyListAccountsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [CurrencyListAccountsParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [CurrencyListAccountsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(currencyListAccountsParams: CurrencyListAccountsParams) = apply {
            code = currencyListAccountsParams.code
            date = currencyListAccountsParams.date
            limit = currencyListAccountsParams.limit
            page = currencyListAccountsParams.page
            type = currencyListAccountsParams.type
            xTraceId = currencyListAccountsParams.xTraceId
            additionalHeaders = currencyListAccountsParams.additionalHeaders.toBuilder()
            additionalQueryParams = currencyListAccountsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CurrencyListAccountsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CurrencyListAccountsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrencyListAccountsParams &&
            code == other.code &&
            date == other.date &&
            limit == other.limit &&
            page == other.page &&
    ...
    override fun toString() =
        "CurrencyListAccountsParams{code=$code, date=$date, limit=$limit, page=$page, type=$type, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
