...
class AutocompleteListCurrenciesWithCodeResponse
...
private constructor(
    ...
    /** A builder for [AutocompleteListCurrenciesWithCodeResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = autocompleteListCurrenciesWithCodeResponse.id
            code = autocompleteListCurrenciesWithCodeResponse.code
            decimalPlaces = autocompleteListCurrenciesWithCodeResponse.decimalPlaces
            name = autocompleteListCurrenciesWithCodeResponse.name
            symbol = autocompleteListCurrenciesWithCodeResponse.symbol
            additionalProperties =
                autocompleteListCurrenciesWithCodeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListCurrenciesWithCodeResponse].
         *
         ...
         */
        fun build(): AutocompleteListCurrenciesWithCodeResponse =
            AutocompleteListCurrenciesWithCodeResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListCurrenciesWithCodeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListCurrenciesWithCodeResponse &&
            id == other.id &&
            code == other.code &&
    ...
    override fun toString() =
        "AutocompleteListCurrenciesWithCodeResponse{id=$id, code=$code, decimalPlaces=$decimalPlaces, name=$name, symbol=$symbol, additionalProperties=$additionalProperties}"
}
