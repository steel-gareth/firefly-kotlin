...
class LinkTypeServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    LinkTypeService {

    private val withRawResponse: LinkTypeService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): LinkTypeService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LinkTypeService =
        LinkTypeServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun delete(params: LinkTypeDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        LinkTypeService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            LinkTypeServiceImpl.WithRawResponseImpl(
