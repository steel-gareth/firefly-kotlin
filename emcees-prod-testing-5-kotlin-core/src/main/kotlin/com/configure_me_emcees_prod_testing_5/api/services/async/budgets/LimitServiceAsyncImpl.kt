...
package com.configure_me_emcees_prod_testing_5.api.services.async.budgets
...
class LimitServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): LimitServiceAsync =
        LimitServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun delete(params: LimitDeleteParams, requestOptions: RequestOptions) {
        // delete /v1/budgets/{id}/limits/{limitId}
        withRawResponse().delete(params, requestOptions)
    }

    override suspend fun list0(
