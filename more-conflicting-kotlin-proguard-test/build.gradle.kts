...
dependencies {
    testImplementation(project(":more-conflicting-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../more-conflicting-kotlin-core/src/main/resources/META-INF/proguard/more-conflicting-kotlin-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../more-conflicting-kotlin-core/src/main/resources/META-INF/proguard/more-conflicting-kotlin-core.pro",
