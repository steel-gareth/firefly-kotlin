...
private constructor(
    ...
    companion object {
        ...
        fun none(): BudgetRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BudgetRetrieveParams]. */
        fun builder() = Builder()
    }

    /** A builder for [BudgetRetrieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(budgetRetrieveParams: BudgetRetrieveParams) = apply {
            id = budgetRetrieveParams.id
            end = budgetRetrieveParams.end
            start = budgetRetrieveParams.start
            xTraceId = budgetRetrieveParams.xTraceId
            additionalHeaders = budgetRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = budgetRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BudgetRetrieveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BudgetRetrieveParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BudgetRetrieveParams &&
            id == other.id &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "BudgetRetrieveParams{id=$id, end=$end, start=$start, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
