 ...
 * tag.
 */
class ExpenseListWithoutTagParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpenseListWithoutTagParams].
         *
    ...
    /** A builder for [ExpenseListWithoutTagParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseListWithoutTagParams: ExpenseListWithoutTagParams) = apply {
            end = expenseListWithoutTagParams.end
            start = expenseListWithoutTagParams.start
            accounts = expenseListWithoutTagParams.accounts?.toMutableList()
            xTraceId = expenseListWithoutTagParams.xTraceId
            additionalHeaders = expenseListWithoutTagParams.additionalHeaders.toBuilder()
            additionalQueryParams = expenseListWithoutTagParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExpenseListWithoutTagParams].
         *
         ...
         */
        fun build(): ExpenseListWithoutTagParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseListWithoutTagParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseListWithoutTagParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
