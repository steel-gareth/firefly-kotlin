...
import com.configure_me_emcees_prod_testing_5.api.errors.MoreConflictingInvalidDataException
...
private constructor(
    ...
    /**
     * @throws MoreConflictingInvalidDataException if the JSON field has an unexpected type or is
    ...
    /**
     * @throws MoreConflictingInvalidDataException if the JSON field has an unexpected type (e.g. if
     ...
     *
     * @throws MoreConflictingInvalidDataException if any value type in this object doesn't match
     *   its expected type.
     */
    ...
    fun isValid(): Boolean =
        try {
            validate()
            true
        } catch (e: MoreConflictingInvalidDataException) {
            false
        }
    ...
    class Status @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
         ...
         *
         * @throws MoreConflictingInvalidDataException if this class instance's value is a not a
         *   known member.
         */
        fun known(): Known =
            when (this) {
                ...
                SOLD -> Known.SOLD
                else -> throw MoreConflictingInvalidDataException("Unknown Status: $value")
            }
         ...
         *
         * @throws MoreConflictingInvalidDataException if this class instance's value does not have
         *   the expected primitive type.
         */
        fun asString(): String =
            _value().asString()
                ?: throw MoreConflictingInvalidDataException("Value is not a String")
         ...
         * This method is _not_ forwards compatible with new types from the API for existing fields.
         *
         * @throws MoreConflictingInvalidDataException if any value type in this object doesn't
