...
private constructor(
    ...
    companion object {
        ...
        fun none(): TagRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(tagRetrieveParams: TagRetrieveParams) = apply {
            tag = tagRetrieveParams.tag
            limit = tagRetrieveParams.limit
            page = tagRetrieveParams.page
            xTraceId = tagRetrieveParams.xTraceId
    ...
    override fun toString() =
        "TagRetrieveParams{tag=$tag, limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
