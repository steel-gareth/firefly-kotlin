...
private constructor(
    ...
    companion object {
        ...
        fun none(): RuleListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(ruleListParams: RuleListParams) = apply {
            ...
            xTraceId = ruleListParams.xTraceId
    ...
    override fun toString() =
        "RuleListParams{limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
