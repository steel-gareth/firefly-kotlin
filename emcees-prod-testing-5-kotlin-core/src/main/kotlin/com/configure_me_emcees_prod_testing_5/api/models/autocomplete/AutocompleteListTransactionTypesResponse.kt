...
class AutocompleteListTransactionTypesResponse
...
private constructor(
    ...
    /** A builder for [AutocompleteListTransactionTypesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = autocompleteListTransactionTypesResponse.id
            name = autocompleteListTransactionTypesResponse.name
            type = autocompleteListTransactionTypesResponse.type
            additionalProperties =
                autocompleteListTransactionTypesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListTransactionTypesResponse].
         *
         ...
         */
        fun build(): AutocompleteListTransactionTypesResponse =
            AutocompleteListTransactionTypesResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListTransactionTypesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListTransactionTypesResponse &&
            id == other.id &&
            name == other.name &&
            type == other.type &&
    ...
    override fun toString() =
        "AutocompleteListTransactionTypesResponse{id=$id, name=$name, type=$type, additionalProperties=$additionalProperties}"
}
