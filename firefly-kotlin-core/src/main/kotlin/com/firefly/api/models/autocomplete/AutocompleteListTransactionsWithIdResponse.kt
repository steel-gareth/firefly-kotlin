...
class AutocompleteListTransactionsWithIdResponse
...
private constructor(
    ...
    ) : this(id, description, name, transactionGroupId, mutableMapOf())
     ...
     */
    fun transactionGroupId(): String? = transactionGroupId.getNullable("transaction_group_id")
     ...
     *
     * Unlike [transactionGroupId], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    @JsonProperty("transaction_group_id")
    @ExcludeMissing
    ...
    /** A builder for [AutocompleteListTransactionsWithIdResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = autocompleteListTransactionsWithIdResponse.id
            description = autocompleteListTransactionsWithIdResponse.description
            name = autocompleteListTransactionsWithIdResponse.name
            transactionGroupId = autocompleteListTransactionsWithIdResponse.transactionGroupId
            additionalProperties =
                autocompleteListTransactionsWithIdResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.transactionGroupId] with a well-typed [String] value
        ...
        /**
         * Returns an immutable instance of [AutocompleteListTransactionsWithIdResponse].
         *
         ...
         */
        fun build(): AutocompleteListTransactionsWithIdResponse =
            AutocompleteListTransactionsWithIdResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): AutocompleteListTransactionsWithIdResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListTransactionsWithIdResponse &&
            id == other.id &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, description, name, transactionGroupId, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AutocompleteListTransactionsWithIdResponse{id=$id, description=$description, name=$name, transactionGroupId=$transactionGroupId, additionalProperties=$additionalProperties}"
}
