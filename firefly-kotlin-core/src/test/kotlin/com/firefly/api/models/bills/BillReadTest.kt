...
internal class BillReadTest {
    ...
    fun create() {
        ...
        assertThat(billRead.id()).isEqualTo("2")
        assertThat(billRead.attributes())
            .isEqualTo(
                BillRead.Attributes.builder()
                    .active(true)
                    .amountAvg("123.45")
        ...
        assertThat(billRead.type()).isEqualTo("bills")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedBillRead =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(billRead),
                jacksonTypeRef<BillRead>(),
            )

        assertThat(roundtrippedBillRead).isEqualTo(billRead)
    }
}
