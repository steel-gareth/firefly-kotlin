...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userUpdateParams: UserUpdateParams) = apply {
            ...
            xTraceId = userUpdateParams.xTraceId
    ...
    override fun hashCode(): Int =
        Objects.hash(id, xTraceId, user, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "UserUpdateParams{id=$id, xTraceId=$xTraceId, user=$user, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
