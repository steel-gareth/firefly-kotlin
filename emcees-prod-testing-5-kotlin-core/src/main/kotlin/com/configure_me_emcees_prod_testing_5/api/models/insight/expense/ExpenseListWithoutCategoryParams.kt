 ...
 * category.
 */
class ExpenseListWithoutCategoryParams
private constructor(
    ...
    /** A builder for [ExpenseListWithoutCategoryParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseListWithoutCategoryParams: ExpenseListWithoutCategoryParams) =
            apply {
                end = expenseListWithoutCategoryParams.end
                start = expenseListWithoutCategoryParams.start
                accounts = expenseListWithoutCategoryParams.accounts?.toMutableList()
                xTraceId = expenseListWithoutCategoryParams.xTraceId
                additionalHeaders = expenseListWithoutCategoryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    expenseListWithoutCategoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ExpenseListWithoutCategoryParams].
         *
         ...
         */
        fun build(): ExpenseListWithoutCategoryParams =
            ExpenseListWithoutCategoryParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseListWithoutCategoryParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseListWithoutCategoryParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
