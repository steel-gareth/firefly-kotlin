 ...
 * transactions.
 */
class TransactionJournalServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    TransactionJournalService {

    private val withRawResponse: TransactionJournalService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): TransactionJournalService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TransactionJournalService =
        TransactionJournalServiceImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override fun delete(params: TransactionJournalDeleteParams, requestOptions: RequestOptions) {
        // delete /v1/transaction-journals/{id}
        withRawResponse().delete(params, requestOptions)
    }

    override fun listLinks(
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TransactionJournalServiceImpl.WithRawResponseImpl(
