...
private constructor(
    private val data: JsonField<List<RecurrenceRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<RecurrenceRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<RecurrenceRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<RecurrenceRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RecurrenceArray].
         *
    ...
    /** A builder for [RecurrenceArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<RecurrenceRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(recurrenceArray: RecurrenceArray) = apply {
            data = recurrenceArray.data.map { it.toMutableList() }
            links = recurrenceArray.links
            meta = recurrenceArray.meta
            additionalProperties = recurrenceArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<RecurrenceRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<RecurrenceRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<RecurrenceRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [RecurrenceRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: RecurrenceRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RecurrenceArray].
         *
     ...
     *   its expected type.
     */
    fun validate(): RecurrenceArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecurrenceArray &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "RecurrenceArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
