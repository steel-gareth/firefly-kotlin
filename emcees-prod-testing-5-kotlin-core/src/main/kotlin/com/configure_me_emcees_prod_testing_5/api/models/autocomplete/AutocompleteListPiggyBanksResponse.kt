...
class AutocompleteListPiggyBanksResponse
...
private constructor(
    ...
    /**
     * Currency code for this piggy bank. This will always be the currency of the piggy bank, never
    ...
    /**
     * Number of decimal places for the currency used by this piggy bank. This will always be the
    ...
    /**
     * Currency ID for this piggy bank. This will always be the currency of the piggy bank, never
     * the user's primary currency.
     *
     * @throws EmceesProdTesting5InvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    /**
     * Currency name for the currency used by this piggy bank. This will always be the currency of
     * the piggy bank, never the user's primary currency.
     *
     * @throws EmceesProdTesting5InvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /** A builder for [AutocompleteListPiggyBanksResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteListPiggyBanksResponse: AutocompleteListPiggyBanksResponse) =
            apply {
                id = autocompleteListPiggyBanksResponse.id
                name = autocompleteListPiggyBanksResponse.name
                currencyCode = autocompleteListPiggyBanksResponse.currencyCode
                currencyDecimalPlaces = autocompleteListPiggyBanksResponse.currencyDecimalPlaces
                currencyId = autocompleteListPiggyBanksResponse.currencyId
                currencyName = autocompleteListPiggyBanksResponse.currencyName
                currencySymbol = autocompleteListPiggyBanksResponse.currencySymbol
                objectGroupId = autocompleteListPiggyBanksResponse.objectGroupId
                objectGroupTitle = autocompleteListPiggyBanksResponse.objectGroupTitle
                additionalProperties =
                    autocompleteListPiggyBanksResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Currency code for this piggy bank. This will always be the currency of the piggy bank,
         * never the user's primary currency.
         */
        ...
        /**
         * Number of decimal places for the currency used by this piggy bank. This will always be
        ...
        /**
         * Currency ID for this piggy bank. This will always be the currency of the piggy bank,
         * never the user's primary currency.
         */
        ...
        /**
         * Currency name for the currency used by this piggy bank. This will always be the currency
        ...
        /**
         * Returns an immutable instance of [AutocompleteListPiggyBanksResponse].
         *
         ...
         */
        fun build(): AutocompleteListPiggyBanksResponse =
            AutocompleteListPiggyBanksResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListPiggyBanksResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListPiggyBanksResponse &&
            id == other.id &&
            name == other.name &&
