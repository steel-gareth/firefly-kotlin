...
private constructor(
    private val data: JsonField<List<CategoryRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CategoryRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CategoryRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CategoryRead>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CategoryRead>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(categoryListResponse: CategoryListResponse) = apply {
            data = categoryListResponse.data.map { it.toMutableList() }
            meta = categoryListResponse.meta
            additionalProperties = categoryListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CategoryRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CategoryRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CategoryRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CategoryRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CategoryRead) = apply {
            this.data =
    ...
    override fun toString() =
        "CategoryListResponse{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
