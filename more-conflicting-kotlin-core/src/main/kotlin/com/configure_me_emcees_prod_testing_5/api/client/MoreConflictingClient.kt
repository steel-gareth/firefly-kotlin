...
/**
 * A client for interacting with the More Conflicting REST API synchronously. You can also switch to
 ...
 * may call [close].
 */
interface MoreConflictingClient {
     ...
     * this client.
     */
    fun async(): MoreConflictingClientAsync
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MoreConflictingClient
    ...
    /**
     * A view of [MoreConflictingClient] that provides access to raw HTTP responses for each method.
     */
