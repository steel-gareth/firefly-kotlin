...
private constructor(
    ...
    companion object {
        ...
        fun none(): AttachmentListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(attachmentListParams: AttachmentListParams) = apply {
            ...
            page = attachmentListParams.page
            xTraceId = attachmentListParams.xTraceId
    ...
    override fun toString() =
        "AttachmentListParams{limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
