...
private constructor(
     ...
     *
     * Use the one published in `more-conflicting-kotlin-client-okhttp` or implement your own.
     *
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("moreconflicting.baseUrl")
                    ?: System.getenv("MORE_CONFLICTING_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("moreconflicting.petstoreApiKey")
                    ?: System.getenv("PETSTORE_API_KEY"))
                ?.let { apiKey(it) }
            System.getenv("MORE_CONFLICTING_CUSTOM_HEADERS")?.let { customHeadersEnv ->
