...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = RecurrenceRepetitionType(JsonField.of(value))
    }

    /** An enum containing [RecurrenceRepetitionType]'s known values. */
    enum class Known {
        DAILY,
        WEEKLY,
        NDOM,
    ...
    /**
     * An enum containing [RecurrenceRepetitionType]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [RecurrenceRepetitionType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        YEARLY,
        /**
         * An enum member indicating that [RecurrenceRepetitionType] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
        ...
        when (this) {
            ...
            YEARLY -> Known.YEARLY
                ...
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown RecurrenceRepetitionType: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): RecurrenceRepetitionType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecurrenceRepetitionType && value == other.value
    }
