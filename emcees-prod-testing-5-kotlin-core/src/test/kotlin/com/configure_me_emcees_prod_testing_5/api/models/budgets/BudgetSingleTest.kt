...
internal class BudgetSingleTest {

    @Test
    fun create() {
        val budgetSingle =
            BudgetSingle.builder()
                .data(
                    BudgetRead.builder()
                        .id("2")
                        .attributes(
    ...
    fun roundtrip() {
        ...
        val roundtrippedBudgetSingle =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(budgetSingle),
                jacksonTypeRef<BudgetSingle>(),
            )

        assertThat(roundtrippedBudgetSingle).isEqualTo(budgetSingle)
    }
}
