...
class TransactionTypeFilter @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        val EXPENSE = of("expense")

        val DEPOSIT = of("deposit")

        val DEPOSITS = of("deposits")

        val INCOME = of("income")

        val TRANSFER = of("transfer")

        val TRANSFERS = of("transfers")

        val OPENING_BALANCE = of("opening_balance")

        val RECONCILIATION = of("reconciliation")

        val SPECIAL = of("special")

        val SPECIALS = of("specials")

        val DEFAULT = of("default")

        fun of(value: String) = TransactionTypeFilter(JsonField.of(value))
    }

    /** An enum containing [TransactionTypeFilter]'s known values. */
    enum class Known {
        ALL,
        WITHDRAWAL,
        WITHDRAWALS,
    ...
    /**
     * An enum containing [TransactionTypeFilter]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [TransactionTypeFilter] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        DEFAULT,
        /**
         * An enum member indicating that [TransactionTypeFilter] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            OPENING_BALANCE -> Known.OPENING_BALANCE
            RECONCILIATION -> Known.RECONCILIATION
            SPECIAL -> Known.SPECIAL
            SPECIALS -> Known.SPECIALS
            DEFAULT -> Known.DEFAULT
            else ->
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown TransactionTypeFilter: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): TransactionTypeFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionTypeFilter && value == other.value
    }
