...
class AutocompleteListRecurringTransactionsResponse
...
private constructor(
    ...
    ) : this(id, name, active, description, mutableMapOf())
    ...
    /** A builder for [AutocompleteListRecurringTransactionsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = autocompleteListRecurringTransactionsResponse.id
            name = autocompleteListRecurringTransactionsResponse.name
            active = autocompleteListRecurringTransactionsResponse.active
            description = autocompleteListRecurringTransactionsResponse.description
            additionalProperties =
                autocompleteListRecurringTransactionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListRecurringTransactionsResponse].
         *
         ...
         */
        fun build(): AutocompleteListRecurringTransactionsResponse =
            AutocompleteListRecurringTransactionsResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListRecurringTransactionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListRecurringTransactionsResponse &&
            id == other.id &&
            name == other.name &&
            active == other.active &&
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, name, active, description, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AutocompleteListRecurringTransactionsResponse{id=$id, name=$name, active=$active, description=$description, additionalProperties=$additionalProperties}"
}
