 ...
 */
class AccountRetrieveOverviewParams
private constructor(
    ...
    /** A builder for [AccountRetrieveOverviewParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveOverviewParams: AccountRetrieveOverviewParams) = apply {
            end = accountRetrieveOverviewParams.end
            start = accountRetrieveOverviewParams.start
            period = accountRetrieveOverviewParams.period
            preselected = accountRetrieveOverviewParams.preselected
            xTraceId = accountRetrieveOverviewParams.xTraceId
            additionalHeaders = accountRetrieveOverviewParams.additionalHeaders.toBuilder()
            additionalQueryParams = accountRetrieveOverviewParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AccountRetrieveOverviewParams].
         *
         ...
         */
        fun build(): AccountRetrieveOverviewParams =
            AccountRetrieveOverviewParams(
    ...
    class Preselected @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        fun known(): Known =
            when (this) {
                ...
                else -> throw FireflyInvalidDataException("Unknown Preselected: $value")
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountRetrieveOverviewParams &&
            end == other.end &&
            start == other.start &&
            period == other.period &&
    ...
    override fun toString() =
        "AccountRetrieveOverviewParams{end=$end, start=$start, period=$period, preselected=$preselected, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
