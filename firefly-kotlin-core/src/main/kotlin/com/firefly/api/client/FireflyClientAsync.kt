...
/**
 * A client for interacting with the Firefly REST API asynchronously. You can also switch to
...
interface FireflyClientAsync {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): FireflyClientAsync
    ...
    /**
     * A view of [FireflyClientAsync] that provides access to raw HTTP responses for each method.
     */
