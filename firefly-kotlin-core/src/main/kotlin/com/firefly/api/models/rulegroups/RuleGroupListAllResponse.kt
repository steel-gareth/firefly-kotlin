...
class RuleGroupListAllResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<RuleGroupRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<RuleGroupRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<RuleGroupRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<RuleGroupRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RuleGroupListAllResponse].
         *
    ...
    /** A builder for [RuleGroupListAllResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<RuleGroupRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(ruleGroupListAllResponse: RuleGroupListAllResponse) = apply {
            data = ruleGroupListAllResponse.data.map { it.toMutableList() }
            links = ruleGroupListAllResponse.links
            meta = ruleGroupListAllResponse.meta
            additionalProperties = ruleGroupListAllResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<RuleGroupRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<RuleGroupRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<RuleGroupRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [RuleGroupRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: RuleGroupRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RuleGroupListAllResponse].
         *
         ...
         */
        fun build(): RuleGroupListAllResponse =
     ...
     *   expected type.
     */
    fun validate(): RuleGroupListAllResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RuleGroupListAllResponse &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "RuleGroupListAllResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
