...
private constructor(
    private val data: JsonField<WebhookMessage>,
    private val additionalProperties: MutableMap<String, JsonValue>,
) {

    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<WebhookMessage> = JsonMissing.of()
     ...
     */
    fun data(): WebhookMessage = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<WebhookMessage> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<WebhookMessage>? = null
        ...
        fun data(data: WebhookMessage) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [WebhookMessage] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<WebhookMessage>) = apply { this.data = data }
