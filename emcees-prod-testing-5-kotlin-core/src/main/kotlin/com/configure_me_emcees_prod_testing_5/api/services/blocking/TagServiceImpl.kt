...
import com.configure_me_emcees_prod_testing_5.api.models.tags.TagListResponse
...
import com.configure_me_emcees_prod_testing_5.api.models.tags.TagSingle
...
class TagServiceImpl internal constructor(private val clientOptions: ClientOptions) : TagService {
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): TagService =
        TagServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun create(params: TagCreateParams, requestOptions: RequestOptions): TagSingle =
        // post /v1/tags
        withRawResponse().create(params, requestOptions).parse()

    override fun retrieve(params: TagRetrieveParams, requestOptions: RequestOptions): TagSingle =
        // get /v1/tags/{tag}
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: TagUpdateParams, requestOptions: RequestOptions): TagSingle =
        // put /v1/tags/{tag}
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            TagServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
