...
internal class TransactionLinkArrayTest {

    @Test
    fun create() {
        val transactionLinkArray =
            TransactionLinkArray.builder()
                .addData(
        ...
        assertThat(transactionLinkArray.data())
            .containsExactly(
                TransactionLinkRead.builder()
                    .id("2")
                    .attributes(
        ...
        assertThat(transactionLinkArray.links())
            .isEqualTo(
                PageLink.builder()
                    .first("https://demo.firefly-iii.org/api/v1/OBJECT?&page=1")
                    .last("https://demo.firefly-iii.org/api/v1/OBJECT?&page=12")
        ...
        assertThat(transactionLinkArray.meta())
            .isEqualTo(
                Meta.builder()
                    .pagination(
                        Meta.Pagination.builder()
    ...
    fun roundtrip() {
        ...
        val roundtrippedTransactionLinkArray =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(transactionLinkArray),
                jacksonTypeRef<TransactionLinkArray>(),
            )

        assertThat(roundtrippedTransactionLinkArray).isEqualTo(transactionLinkArray)
    }
}
