...
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AboutServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AccountService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AccountServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AttachmentService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AttachmentServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AutocompleteService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AutocompleteServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AvailableBudgetService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.AvailableBudgetServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BatchService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BatchServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BillService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BillServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BudgetService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.BudgetServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CategoryService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CategoryServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ChartService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ChartServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ConfigurationService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ConfigurationServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CronService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CronServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CurrencyService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.CurrencyServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.DataService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.DataServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ExchangeRateService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ExchangeRateServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.InsightService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.InsightServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.LinkTypeService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.LinkTypeServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ObjectGroupService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.ObjectGroupServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.PiggyBankService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.PiggyBankServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.PreferenceService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.PreferenceServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RecurrenceService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RecurrenceServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RuleGroupService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RuleGroupServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RuleService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.RuleServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.SearchService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.SearchServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.SummaryService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.SummaryServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TagService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TagServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionJournalService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionJournalServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionLinkService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionLinkServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.TransactionServiceImpl
import com.configure_me_emcees_prod_testing_5.api.services.blocking.UserGroupService
import com.configure_me_emcees_prod_testing_5.api.services.blocking.UserGroupServiceImpl
...
import com.configure_me_emcees_prod_testing_5.api.services.blocking.WebhookServiceImpl

class EmceesProdTesting5ClientImpl(private val clientOptions: ClientOptions) :
    EmceesProdTesting5Client {
    ...
    private val async: EmceesProdTesting5ClientAsync by lazy {
        EmceesProdTesting5ClientAsyncImpl(clientOptions)
    }

    private val withRawResponse: EmceesProdTesting5Client.WithRawResponse by lazy {
    ...
    override fun async(): EmceesProdTesting5ClientAsync = async

    override fun withRawResponse(): EmceesProdTesting5Client.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): EmceesProdTesting5Client =
        EmceesProdTesting5ClientImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            EmceesProdTesting5ClientImpl.WithRawResponseImpl(
