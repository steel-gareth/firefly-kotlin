...
class AutocompleteListRuleGroupsResponse
...
private constructor(
    ...
    /** A builder for [AutocompleteListRuleGroupsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteListRuleGroupsResponse: AutocompleteListRuleGroupsResponse) =
            apply {
                id = autocompleteListRuleGroupsResponse.id
                name = autocompleteListRuleGroupsResponse.name
                active = autocompleteListRuleGroupsResponse.active
                description = autocompleteListRuleGroupsResponse.description
                additionalProperties =
                    autocompleteListRuleGroupsResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListRuleGroupsResponse].
         *
         ...
         */
        fun build(): AutocompleteListRuleGroupsResponse =
            AutocompleteListRuleGroupsResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): AutocompleteListRuleGroupsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListRuleGroupsResponse &&
            id == other.id &&
            name == other.name &&
            active == other.active &&
    ...
    override fun toString() =
        "AutocompleteListRuleGroupsResponse{id=$id, name=$name, active=$active, description=$description, additionalProperties=$additionalProperties}"
}
