...
private constructor(
    ...
    companion object {
        ...
        fun none(): LimitList0Params = builder().build()

        /** Returns a mutable builder for constructing an instance of [LimitList0Params]. */
        fun builder() = Builder()
    }

    /** A builder for [LimitList0Params]. */
    class Builder internal constructor() {
        ...
        internal fun from(limitList0Params: LimitList0Params) = apply {
            id = limitList0Params.id
            end = limitList0Params.end
            start = limitList0Params.start
            xTraceId = limitList0Params.xTraceId
            additionalHeaders = limitList0Params.additionalHeaders.toBuilder()
            additionalQueryParams = limitList0Params.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LimitList0Params].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LimitList0Params =
            LimitList0Params(
                id,
                end,
                start,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LimitList0Params &&
            id == other.id &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "LimitList0Params{id=$id, end=$end, start=$start, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
