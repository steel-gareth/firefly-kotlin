...
internal class PiggyBankSingleTest {

    @Test
    fun create() {
        val piggyBankSingle =
            PiggyBankSingle.builder()
                .data(
        ...
        assertThat(piggyBankSingle.data())
            .isEqualTo(
                PiggyBankRead.builder()
                    .id("2")
                    .attributes(
    ...
    fun roundtrip() {
        ...
        val roundtrippedPiggyBankSingle =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(piggyBankSingle),
                jacksonTypeRef<PiggyBankSingle>(),
            )

        assertThat(roundtrippedPiggyBankSingle).isEqualTo(piggyBankSingle)
    }
}
