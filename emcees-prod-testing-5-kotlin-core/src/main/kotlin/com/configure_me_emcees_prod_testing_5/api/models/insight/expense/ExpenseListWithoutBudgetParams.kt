 ...
 * budget.
 */
class ExpenseListWithoutBudgetParams
private constructor(
    ...
    /** A builder for [ExpenseListWithoutBudgetParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseListWithoutBudgetParams: ExpenseListWithoutBudgetParams) = apply {
            end = expenseListWithoutBudgetParams.end
            start = expenseListWithoutBudgetParams.start
            accounts = expenseListWithoutBudgetParams.accounts?.toMutableList()
            xTraceId = expenseListWithoutBudgetParams.xTraceId
            additionalHeaders = expenseListWithoutBudgetParams.additionalHeaders.toBuilder()
            additionalQueryParams = expenseListWithoutBudgetParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExpenseListWithoutBudgetParams].
         *
         ...
         */
        fun build(): ExpenseListWithoutBudgetParams =
            ExpenseListWithoutBudgetParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseListWithoutBudgetParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseListWithoutBudgetParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
