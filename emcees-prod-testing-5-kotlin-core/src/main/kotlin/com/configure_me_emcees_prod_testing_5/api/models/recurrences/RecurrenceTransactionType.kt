...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = RecurrenceTransactionType(JsonField.of(value))
    }

    /** An enum containing [RecurrenceTransactionType]'s known values. */
    enum class Known {
        WITHDRAWAL,
        TRANSFER,
        DEPOSIT,
    ...
    /**
     * An enum containing [RecurrenceTransactionType]'s known values, as well as an [_UNKNOWN]
     * member.
     *
     * An instance of [RecurrenceTransactionType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        DEPOSIT,
        /**
         * An enum member indicating that [RecurrenceTransactionType] was instantiated with an
         * unknown value.
         */
        _UNKNOWN,
    }
        ...
        when (this) {
            ...
            DEPOSIT -> Known.DEPOSIT
                ...
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown RecurrenceTransactionType: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): RecurrenceTransactionType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecurrenceTransactionType && value == other.value
    }
