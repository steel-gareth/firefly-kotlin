...
private constructor(
    private val data: JsonField<List<BillRead>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<BillRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BillRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BillRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BillArray].
         *
    ...
    /** A builder for [BillArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BillRead>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(billArray: BillArray) = apply {
            data = billArray.data.map { it.toMutableList() }
            meta = billArray.meta
            additionalProperties = billArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<BillRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BillRead>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<BillRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BillRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BillRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [BillArray].
         *
    ...
    override fun toString() =
        "BillArray{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
