 ...
 * category.
 */
class IncomeListWithoutCategoryParams
private constructor(
    ...
    /** A builder for [IncomeListWithoutCategoryParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomeListWithoutCategoryParams: IncomeListWithoutCategoryParams) =
            apply {
                end = incomeListWithoutCategoryParams.end
                start = incomeListWithoutCategoryParams.start
                accounts = incomeListWithoutCategoryParams.accounts?.toMutableList()
                xTraceId = incomeListWithoutCategoryParams.xTraceId
                additionalHeaders = incomeListWithoutCategoryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    incomeListWithoutCategoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [IncomeListWithoutCategoryParams].
         *
         ...
         */
        fun build(): IncomeListWithoutCategoryParams =
            IncomeListWithoutCategoryParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeListWithoutCategoryParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "IncomeListWithoutCategoryParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
