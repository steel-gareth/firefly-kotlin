...
import com.firefly.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw FireflyInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw FireflyInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
