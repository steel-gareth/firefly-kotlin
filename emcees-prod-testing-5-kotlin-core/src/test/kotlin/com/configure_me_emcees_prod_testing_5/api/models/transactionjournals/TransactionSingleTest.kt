...
internal class TransactionSingleTest {

    @Test
    fun create() {
        val transactionSingle =
            TransactionSingle.builder()
                .data(
        ...
        assertThat(transactionSingle.data())
            .isEqualTo(
                TransactionRead.builder()
                    .id("2")
                    .attributes(
    ...
    fun roundtrip() {
        ...
        val roundtrippedTransactionSingle =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(transactionSingle),
                jacksonTypeRef<TransactionSingle>(),
            )

        assertThat(roundtrippedTransactionSingle).isEqualTo(transactionSingle)
    }
}
