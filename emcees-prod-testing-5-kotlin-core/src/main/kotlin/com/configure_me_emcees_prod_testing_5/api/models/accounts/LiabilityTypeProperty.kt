...
class LiabilityTypeProperty @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = LiabilityTypeProperty(JsonField.of(value))
    }

    /** An enum containing [LiabilityTypeProperty]'s known values. */
    enum class Known {
        LOAN,
        DEBT,
        MORTGAGE,
    ...
    /**
     * An enum containing [LiabilityTypeProperty]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [LiabilityTypeProperty] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        MORTGAGE,
        /**
         * An enum member indicating that [LiabilityTypeProperty] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
        ...
        when (this) {
            ...
            MORTGAGE -> Known.MORTGAGE
                ...
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown LiabilityTypeProperty: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): LiabilityTypeProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LiabilityTypeProperty && value == other.value
    }
