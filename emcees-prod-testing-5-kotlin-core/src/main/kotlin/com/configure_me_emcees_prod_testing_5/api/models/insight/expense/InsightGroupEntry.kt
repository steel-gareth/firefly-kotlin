...
private constructor(
    ...
    ) : this(id, currencyCode, currencyId, difference, differenceFloat, name, mutableMapOf())
    ...
    /**
     * The amount spent or earned between start date and end date, a number defined as a string, for
     * this object and all asset accounts.
     *
     * @throws EmceesProdTesting5InvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    /**
     * The amount spent or earned between start date and end date, a number as a float, for this
     * object and all asset accounts. May have rounding errors.
     *
     * @throws EmceesProdTesting5InvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
     */
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [InsightGroupEntry]. */
        fun builder() = Builder()
    }

    /** A builder for [InsightGroupEntry]. */
    class Builder internal constructor() {
        ...
        internal fun from(insightGroupEntry: InsightGroupEntry) = apply {
            id = insightGroupEntry.id
            currencyCode = insightGroupEntry.currencyCode
            currencyId = insightGroupEntry.currencyId
            difference = insightGroupEntry.difference
            differenceFloat = insightGroupEntry.differenceFloat
            name = insightGroupEntry.name
            additionalProperties = insightGroupEntry.additionalProperties.toMutableMap()
        }
        ...
        /**
         * The amount spent or earned between start date and end date, a number defined as a string,
         * for this object and all asset accounts.
         */
        ...
        /**
         * Returns an immutable instance of [InsightGroupEntry].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InsightGroupEntry =
            InsightGroupEntry(
                id,
                currencyCode,
                currencyId,
     ...
     *   its expected type.
     */
    fun validate(): InsightGroupEntry = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InsightGroupEntry &&
            id == other.id &&
    ...
    override fun toString() =
        "InsightGroupEntry{id=$id, currencyCode=$currencyCode, currencyId=$currencyId, difference=$difference, differenceFloat=$differenceFloat, name=$name, additionalProperties=$additionalProperties}"
}
