...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IncomeListByTagParams].
         *
    ...
    /** A builder for [IncomeListByTagParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomeListByTagParams: IncomeListByTagParams) = apply {
            end = incomeListByTagParams.end
            start = incomeListByTagParams.start
            accounts = incomeListByTagParams.accounts?.toMutableList()
            tags = incomeListByTagParams.tags?.toMutableList()
            xTraceId = incomeListByTagParams.xTraceId
            additionalHeaders = incomeListByTagParams.additionalHeaders.toBuilder()
            additionalQueryParams = incomeListByTagParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IncomeListByTagParams].
         *
         ...
         */
        fun build(): IncomeListByTagParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeListByTagParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "IncomeListByTagParams{end=$end, start=$start, accounts=$accounts, tags=$tags, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
