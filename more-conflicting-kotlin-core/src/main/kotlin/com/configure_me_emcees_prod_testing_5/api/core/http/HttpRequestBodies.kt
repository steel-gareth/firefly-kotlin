...
import com.configure_me_emcees_prod_testing_5.api.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw MoreConflictingInvalidDataException(
        ...
        JsonNodeType.POJO,
        null ->
            throw MoreConflictingInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
