...
/**
 * A client for interacting with the Firefly REST API synchronously. You can also switch to
...
interface FireflyClient {
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): FireflyClient
    ...
    /** A view of [FireflyClient] that provides access to raw HTTP responses for each method. */
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: (ClientOptions.Builder) -> Unit): FireflyClient.WithRawResponse
