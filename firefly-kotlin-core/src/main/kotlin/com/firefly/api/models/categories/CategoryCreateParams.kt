...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CategoryCreateParams].
         *
    ...
    /** A builder for [CategoryCreateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(categoryCreateParams: CategoryCreateParams) = apply {
            xTraceId = categoryCreateParams.xTraceId
            body = categoryCreateParams.body.toBuilder()
            additionalHeaders = categoryCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = categoryCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CategoryCreateParams].
         *
         ...
         */
        fun build(): CategoryCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CategoryCreateParams &&
    ...
    override fun toString() =
        "CategoryCreateParams{xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
