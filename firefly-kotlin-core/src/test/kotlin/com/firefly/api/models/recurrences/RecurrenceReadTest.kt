...
internal class RecurrenceReadTest {
    ...
    fun create() {
                    ...
                    RecurrenceRead.Attributes.builder()
                        ...
                        .addRepetition(
                            RecurrenceRead.Attributes.Repetition.builder()
                                ...
                                .addOccurrence(OffsetDateTime.parse("2026-04-30T23:59:59+00:00"))
                                .skip(0)
        ...
        assertThat(recurrenceRead.id()).isEqualTo("2")
        assertThat(recurrenceRead.attributes())
            .isEqualTo(
                RecurrenceRead.Attributes.builder()
                    .active(true)
                    .applyRules(true)
        ...
        assertThat(recurrenceRead.links())
            .isEqualTo(
                ObjectLink.builder()
                    ._0(ObjectLink._0.builder().rel("self").uri("/OBJECTS/1").build())
                    .self("https://demo.firefly-iii.org/api/v1/OBJECTS/1")
        ...
        assertThat(recurrenceRead.type()).isEqualTo("recurrences")
    }
    ...
    fun roundtrip() {
        ...
        val roundtrippedRecurrenceRead =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(recurrenceRead),
                jacksonTypeRef<RecurrenceRead>(),
            )

        assertThat(roundtrippedRecurrenceRead).isEqualTo(recurrenceRead)
    }
}
