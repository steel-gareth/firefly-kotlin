 ...
 * tag.
 */
class IncomeListWithoutTagParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IncomeListWithoutTagParams].
         *
    ...
    /** A builder for [IncomeListWithoutTagParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomeListWithoutTagParams: IncomeListWithoutTagParams) = apply {
            end = incomeListWithoutTagParams.end
            start = incomeListWithoutTagParams.start
            accounts = incomeListWithoutTagParams.accounts?.toMutableList()
            xTraceId = incomeListWithoutTagParams.xTraceId
            additionalHeaders = incomeListWithoutTagParams.additionalHeaders.toBuilder()
            additionalQueryParams = incomeListWithoutTagParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IncomeListWithoutTagParams].
         *
         ...
         */
        fun build(): IncomeListWithoutTagParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeListWithoutTagParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "IncomeListWithoutTagParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
