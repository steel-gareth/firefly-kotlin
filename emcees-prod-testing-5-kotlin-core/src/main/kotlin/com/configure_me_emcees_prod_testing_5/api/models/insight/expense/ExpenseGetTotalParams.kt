...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpenseGetTotalParams].
         *
    ...
    /** A builder for [ExpenseGetTotalParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseGetTotalParams: ExpenseGetTotalParams) = apply {
            end = expenseGetTotalParams.end
            start = expenseGetTotalParams.start
            accounts = expenseGetTotalParams.accounts?.toMutableList()
            xTraceId = expenseGetTotalParams.xTraceId
            additionalHeaders = expenseGetTotalParams.additionalHeaders.toBuilder()
            additionalQueryParams = expenseGetTotalParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExpenseGetTotalParams].
         *
         ...
         */
        fun build(): ExpenseGetTotalParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseGetTotalParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseGetTotalParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
