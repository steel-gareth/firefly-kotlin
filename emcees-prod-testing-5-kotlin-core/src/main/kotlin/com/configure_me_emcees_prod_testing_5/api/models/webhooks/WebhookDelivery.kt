...
class WebhookDelivery @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = WebhookDelivery(JsonField.of(value))
    }

    /** An enum containing [WebhookDelivery]'s known values. */
    enum class Known {
        JSON
    }

    /**
     * An enum containing [WebhookDelivery]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [WebhookDelivery] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        JSON,
        /**
         * An enum member indicating that [WebhookDelivery] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            JSON -> Known.JSON
            else -> throw EmceesProdTesting5InvalidDataException("Unknown WebhookDelivery: $value")
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is WebhookDelivery && value == other.value
    }
