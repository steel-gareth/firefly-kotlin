...
private constructor(
    private val data: JsonField<List<UserGroupRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<UserGroupRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<UserGroupRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<UserGroupRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserGroupListResponse].
         *
    ...
    /** A builder for [UserGroupListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<UserGroupRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(userGroupListResponse: UserGroupListResponse) = apply {
            data = userGroupListResponse.data.map { it.toMutableList() }
            links = userGroupListResponse.links
            meta = userGroupListResponse.meta
            additionalProperties = userGroupListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<UserGroupRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<UserGroupRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<UserGroupRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [UserGroupRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: UserGroupRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [UserGroupListResponse].
         *
         ...
         */
        fun build(): UserGroupListResponse =
     ...
     *   expected type.
     */
    fun validate(): UserGroupListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserGroupListResponse &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "UserGroupListResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
