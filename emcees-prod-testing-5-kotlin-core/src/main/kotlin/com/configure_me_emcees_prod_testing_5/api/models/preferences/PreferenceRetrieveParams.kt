...
private constructor(
    ...
    companion object {
        ...
        fun none(): PreferenceRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(preferenceRetrieveParams: PreferenceRetrieveParams) = apply {
            name = preferenceRetrieveParams.name
            xTraceId = preferenceRetrieveParams.xTraceId
    ...
    override fun toString() =
        "PreferenceRetrieveParams{name=$name, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
