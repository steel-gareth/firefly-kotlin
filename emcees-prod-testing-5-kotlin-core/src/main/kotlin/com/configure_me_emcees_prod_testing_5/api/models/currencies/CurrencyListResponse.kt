...
private constructor(
    private val data: JsonField<List<CurrencyRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CurrencyRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CurrencyRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CurrencyRead>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<CurrencyRead>>? = null
        ...
        internal fun from(currencyListResponse: CurrencyListResponse) = apply {
            ...
            links = currencyListResponse.links
            meta = currencyListResponse.meta
            additionalProperties = currencyListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CurrencyRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CurrencyRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CurrencyRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CurrencyRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CurrencyRead) = apply {
            this.data =
    ...
    override fun toString() =
        "CurrencyListResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
