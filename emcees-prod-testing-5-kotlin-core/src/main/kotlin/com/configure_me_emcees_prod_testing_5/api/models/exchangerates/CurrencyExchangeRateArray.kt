...
private constructor(
    private val data: JsonField<List<CurrencyExchangeRateRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CurrencyExchangeRateRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CurrencyExchangeRateRead> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CurrencyExchangeRateRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CurrencyExchangeRateArray].
         *
    ...
    /** A builder for [CurrencyExchangeRateArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CurrencyExchangeRateRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(currencyExchangeRateArray: CurrencyExchangeRateArray) = apply {
            data = currencyExchangeRateArray.data.map { it.toMutableList() }
            links = currencyExchangeRateArray.links
            meta = currencyExchangeRateArray.meta
            additionalProperties = currencyExchangeRateArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<CurrencyExchangeRateRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CurrencyExchangeRateRead>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CurrencyExchangeRateRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CurrencyExchangeRateRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CurrencyExchangeRateRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CurrencyExchangeRateArray].
         *
         ...
         */
        fun build(): CurrencyExchangeRateArray =
     ...
     *   its expected type.
     */
    fun validate(): CurrencyExchangeRateArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CurrencyExchangeRateArray &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "CurrencyExchangeRateArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
