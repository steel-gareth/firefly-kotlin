...
interface TransferServiceAsync {
    ...
    interface WithRawResponse {
         ...
         * same as [TransferServiceAsync.getTotal].
         */
        @MustBeClosed
        suspend fun getTotal(
            params: TransferGetTotalParams,
         ...
         * same as [TransferServiceAsync.listByAssetAccount].
         */
        @MustBeClosed
        suspend fun listByAssetAccount(
            params: TransferListByAssetAccountParams,
         ...
         * same as [TransferServiceAsync.listByCategory].
         */
        @MustBeClosed
        suspend fun listByCategory(
            params: TransferListByCategoryParams,
         ...
         * as [TransferServiceAsync.listByTag].
         */
        @MustBeClosed
        suspend fun listByTag(
            params: TransferListByTagParams,
         ...
         * the same as [TransferServiceAsync.listWithoutCategory].
         */
        @MustBeClosed
        suspend fun listWithoutCategory(
            params: TransferListWithoutCategoryParams,
         ...
         * same as [TransferServiceAsync.listWithoutTag].
         */
        @MustBeClosed
        suspend fun listWithoutTag(
            params: TransferListWithoutTagParams,
