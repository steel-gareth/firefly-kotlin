...
import com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClientImpl
...
/**
 * A class that allows building an instance of [MoreConflictingClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class MoreConflictingOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [MoreConflictingClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): MoreConflictingClient = builder().fromEnv().build()
    }

    /** A builder for [MoreConflictingOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MoreConflictingClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MoreConflictingClient =
            MoreConflictingClientImpl(
                clientOptions
                    .httpClient(
