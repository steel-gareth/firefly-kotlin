...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AttemptListParams].
         *
    ...
    /** A builder for [AttemptListParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(attemptListParams: AttemptListParams) = apply {
            id = attemptListParams.id
            messageId = attemptListParams.messageId
            limit = attemptListParams.limit
            page = attemptListParams.page
            xTraceId = attemptListParams.xTraceId
            additionalHeaders = attemptListParams.additionalHeaders.toBuilder()
            additionalQueryParams = attemptListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AttemptListParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AttemptListParams &&
            id == other.id &&
    ...
    override fun hashCode(): Int =
        Objects.hash(id, messageId, limit, page, xTraceId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "AttemptListParams{id=$id, messageId=$messageId, limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
