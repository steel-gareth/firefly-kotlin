 ...
 * category.
 */
class TransferListWithoutCategoryParams
private constructor(
    ...
    /** A builder for [TransferListWithoutCategoryParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(transferListWithoutCategoryParams: TransferListWithoutCategoryParams) =
            apply {
                end = transferListWithoutCategoryParams.end
                start = transferListWithoutCategoryParams.start
                accounts = transferListWithoutCategoryParams.accounts?.toMutableList()
                xTraceId = transferListWithoutCategoryParams.xTraceId
                additionalHeaders = transferListWithoutCategoryParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    transferListWithoutCategoryParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TransferListWithoutCategoryParams].
         *
         ...
         */
        fun build(): TransferListWithoutCategoryParams =
            TransferListWithoutCategoryParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferListWithoutCategoryParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "TransferListWithoutCategoryParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
