...
class BillServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): BillServiceAsync =
        BillServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun list(params: BillListParams, requestOptions: RequestOptions): BillArray =
        // get /v1/bills
        withRawResponse().list(params, requestOptions).parse()

    override suspend fun delete(params: BillDeleteParams, requestOptions: RequestOptions) {
        // delete /v1/bills/{id}
