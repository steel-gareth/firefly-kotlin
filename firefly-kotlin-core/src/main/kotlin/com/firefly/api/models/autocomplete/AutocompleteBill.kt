...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutocompleteBill].
         *
    ...
    /** A builder for [AutocompleteBill]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteBill: AutocompleteBill) = apply {
            id = autocompleteBill.id
            name = autocompleteBill.name
            active = autocompleteBill.active
            additionalProperties = autocompleteBill.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteBill].
         *
     ...
     *   expected type.
     */
    fun validate(): AutocompleteBill = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteBill &&
            id == other.id &&
            name == other.name &&
            active == other.active &&
    ...
    override fun toString() =
        "AutocompleteBill{id=$id, name=$name, active=$active, additionalProperties=$additionalProperties}"
}
