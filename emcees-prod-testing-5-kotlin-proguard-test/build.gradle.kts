...
dependencies {
    testImplementation(project(":emcees-prod-testing-5-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../emcees-prod-testing-5-kotlin-core/src/main/resources/META-INF/proguard/emcees-prod-testing-5-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.configure_me_emcees_prod_testing_5.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../emcees-prod-testing-5-kotlin-core/src/main/resources/META-INF/proguard/emcees-prod-testing-5-kotlin-core.pro",
