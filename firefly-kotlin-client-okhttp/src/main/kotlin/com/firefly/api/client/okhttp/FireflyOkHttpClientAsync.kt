...
package com.firefly.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.firefly.api.client.FireflyClientAsync
import com.firefly.api.client.FireflyClientAsyncImpl
import com.firefly.api.core.ClientOptions
import com.firefly.api.core.LogLevel
import com.firefly.api.core.Sleeper
import com.firefly.api.core.Timeout
...
/**
 * A class that allows building an instance of [FireflyClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class FireflyOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [FireflyClientAsync]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): FireflyClientAsync = builder().fromEnv().build()
    }

    /** A builder for [FireflyOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [FireflyClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FireflyClientAsync =
            FireflyClientAsyncImpl(
                clientOptions
                    .httpClient(
