...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(exchangeRateListParams: ExchangeRateListParams) = apply {
            limit = exchangeRateListParams.limit
            page = exchangeRateListParams.page
            xTraceId = exchangeRateListParams.xTraceId
    ...
    override fun toString() =
        "ExchangeRateListParams{limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
