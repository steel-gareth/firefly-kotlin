...
class BillRepeatFrequency @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = BillRepeatFrequency(JsonField.of(value))
    }

    /** An enum containing [BillRepeatFrequency]'s known values. */
    enum class Known {
        WEEKLY,
        MONTHLY,
        QUARTERLY,
    ...
    /**
     * An enum containing [BillRepeatFrequency]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [BillRepeatFrequency] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        YEARLY,
        /**
         * An enum member indicating that [BillRepeatFrequency] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            YEARLY -> Known.YEARLY
                ...
                throw EmceesProdTesting5InvalidDataException("Unknown BillRepeatFrequency: $value")
        }
     ...
     *   its expected type.
     */
    fun validate(): BillRepeatFrequency = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BillRepeatFrequency && value == other.value
    }
