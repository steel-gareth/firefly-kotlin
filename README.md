...
[![Maven Central](https://img.shields.io/maven-central/v/com.firefly.api/firefly-kotlin)](https://central.sonatype.com/artifact/com.firefly.api/firefly-kotlin/0.1.0)
[![javadoc](https://javadoc.io/badge2/com.firefly.api/firefly-kotlin/0.1.0/javadoc.svg)](https://javadoc.io/doc/com.firefly.api/firefly-kotlin/0.1.0)
...
The REST API documentation can be found on [firefly-iii.org](https://firefly-iii.org). KDocs are available on [javadoc.io](https://javadoc.io/doc/com.firefly.api/firefly-kotlin/0.1.0).
...
```kotlin
implementation("com.firefly.api:firefly-kotlin:0.1.0")
```
