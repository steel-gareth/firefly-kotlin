...
private constructor(
    private val data: JsonField<List<LinkTypeRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<LinkTypeRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<LinkTypeRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<LinkTypeRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LinkTypeListResponse].
         *
    ...
    /** A builder for [LinkTypeListResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<LinkTypeRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(linkTypeListResponse: LinkTypeListResponse) = apply {
            data = linkTypeListResponse.data.map { it.toMutableList() }
            links = linkTypeListResponse.links
            meta = linkTypeListResponse.meta
            additionalProperties = linkTypeListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<LinkTypeRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<LinkTypeRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<LinkTypeRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [LinkTypeRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: LinkTypeRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [LinkTypeListResponse].
         *
         ...
         */
        fun build(): LinkTypeListResponse =
     ...
     *   expected type.
     */
    fun validate(): LinkTypeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LinkTypeListResponse &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "LinkTypeListResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
