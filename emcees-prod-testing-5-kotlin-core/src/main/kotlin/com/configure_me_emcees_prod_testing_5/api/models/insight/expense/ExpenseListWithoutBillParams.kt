 ...
 * bill.
 */
class ExpenseListWithoutBillParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpenseListWithoutBillParams].
         *
    ...
    /** A builder for [ExpenseListWithoutBillParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseListWithoutBillParams: ExpenseListWithoutBillParams) = apply {
            end = expenseListWithoutBillParams.end
            start = expenseListWithoutBillParams.start
            accounts = expenseListWithoutBillParams.accounts?.toMutableList()
            xTraceId = expenseListWithoutBillParams.xTraceId
            additionalHeaders = expenseListWithoutBillParams.additionalHeaders.toBuilder()
            additionalQueryParams = expenseListWithoutBillParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExpenseListWithoutBillParams].
         *
         ...
         */
        fun build(): ExpenseListWithoutBillParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseListWithoutBillParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseListWithoutBillParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
