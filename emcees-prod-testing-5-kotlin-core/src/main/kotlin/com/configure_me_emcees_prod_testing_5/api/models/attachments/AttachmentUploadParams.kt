...
private constructor(
    ...
    companion object {
        ...
        fun none(): AttachmentUploadParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(attachmentUploadParams: AttachmentUploadParams) = apply {
            id = attachmentUploadParams.id
            xTraceId = attachmentUploadParams.xTraceId
            body = attachmentUploadParams.body
    ...
    override fun toString() =
        "AttachmentUploadParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
