...
import com.configure_me_emcees_prod_testing_5.api.client.MoreConflictingClientAsyncImpl
...
/**
 * A class that allows building an instance of [MoreConflictingClientAsync] with [OkHttpClient] as
 * the underlying [HttpClient].
 */
class MoreConflictingOkHttpClientAsync private constructor() {

    companion object {

        /**
         * Returns a mutable builder for constructing an instance of [MoreConflictingClientAsync].
         */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): MoreConflictingClientAsync = builder().fromEnv().build()
    }

    /** A builder for [MoreConflictingOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [MoreConflictingClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): MoreConflictingClientAsync =
            MoreConflictingClientAsyncImpl(
                clientOptions
                    .httpClient(
