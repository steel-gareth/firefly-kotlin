...
private constructor(
    ...
    companion object {
        ...
        fun none(): RuleGroupUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RuleGroupUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [RuleGroupUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(ruleGroupUpdateParams: RuleGroupUpdateParams) = apply {
            id = ruleGroupUpdateParams.id
            xTraceId = ruleGroupUpdateParams.xTraceId
            body = ruleGroupUpdateParams.body.toBuilder()
            additionalHeaders = ruleGroupUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = ruleGroupUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [RuleGroupUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RuleGroupUpdateParams =
    ...
    private constructor(
        ...
        ) : this(active, description, order, title, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(active, description, order, title, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(active, description, order, title, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{active=$active, description=$description, order=$order, title=$title, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RuleGroupUpdateParams &&
            id == other.id &&
    ...
    override fun toString() =
        "RuleGroupUpdateParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
