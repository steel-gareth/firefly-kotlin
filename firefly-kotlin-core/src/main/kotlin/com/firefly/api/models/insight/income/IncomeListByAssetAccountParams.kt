...
class IncomeListByAssetAccountParams
private constructor(
    ...
    /** A builder for [IncomeListByAssetAccountParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(incomeListByAssetAccountParams: IncomeListByAssetAccountParams) = apply {
            end = incomeListByAssetAccountParams.end
            start = incomeListByAssetAccountParams.start
            accounts = incomeListByAssetAccountParams.accounts?.toMutableList()
            xTraceId = incomeListByAssetAccountParams.xTraceId
            additionalHeaders = incomeListByAssetAccountParams.additionalHeaders.toBuilder()
            additionalQueryParams = incomeListByAssetAccountParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [IncomeListByAssetAccountParams].
         *
         ...
         */
        fun build(): IncomeListByAssetAccountParams =
            IncomeListByAssetAccountParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IncomeListByAssetAccountParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "IncomeListByAssetAccountParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
