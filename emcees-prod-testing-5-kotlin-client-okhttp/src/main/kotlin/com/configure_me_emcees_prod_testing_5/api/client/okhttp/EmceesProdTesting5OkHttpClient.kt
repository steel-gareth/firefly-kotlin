...
package com.configure_me_emcees_prod_testing_5.api.client.okhttp

import com.configure_me_emcees_prod_testing_5.api.client.EmceesProdTesting5Client
import com.configure_me_emcees_prod_testing_5.api.client.EmceesProdTesting5ClientImpl
import com.configure_me_emcees_prod_testing_5.api.core.ClientOptions
import com.configure_me_emcees_prod_testing_5.api.core.LogLevel
import com.configure_me_emcees_prod_testing_5.api.core.Sleeper
import com.configure_me_emcees_prod_testing_5.api.core.Timeout
...
/**
 * A class that allows building an instance of [EmceesProdTesting5Client] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class EmceesProdTesting5OkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [EmceesProdTesting5Client]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): EmceesProdTesting5Client = builder().fromEnv().build()
    }

    /** A builder for [EmceesProdTesting5OkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [EmceesProdTesting5Client].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EmceesProdTesting5Client =
            EmceesProdTesting5ClientImpl(
                clientOptions
                    .httpClient(
