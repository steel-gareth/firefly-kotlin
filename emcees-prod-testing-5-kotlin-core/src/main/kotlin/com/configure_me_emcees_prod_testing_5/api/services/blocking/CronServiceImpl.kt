...
class CronServiceImpl internal constructor(private val clientOptions: ClientOptions) : CronService {

    private val withRawResponse: CronService.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): CronService.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): CronService =
        CronServiceImpl(clientOptions.toBuilder().apply(modifier).build())

    override fun run(params: CronRunParams, requestOptions: RequestOptions): CronRunResponse =
        // get /v1/cron/{cliToken}
        withRawResponse().run(params, requestOptions).parse()

    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        CronService.WithRawResponse {
        ...
        override fun withOptions(
            ...
            CronServiceImpl.WithRawResponseImpl(clientOptions.toBuilder().apply(modifier).build())
