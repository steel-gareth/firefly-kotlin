...
class AutocompleteListTagsResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AutocompleteListTagsResponse].
         *
    ...
    /** A builder for [AutocompleteListTagsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteListTagsResponse: AutocompleteListTagsResponse) = apply {
            id = autocompleteListTagsResponse.id
            name = autocompleteListTagsResponse.name
            tag = autocompleteListTagsResponse.tag
            additionalProperties = autocompleteListTagsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListTagsResponse].
         *
         ...
         */
        fun build(): AutocompleteListTagsResponse =
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListTagsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListTagsResponse &&
            id == other.id &&
            name == other.name &&
            tag == other.tag &&
    ...
    private val hashCode: Int by lazy { Objects.hash(id, name, tag, additionalProperties) }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "AutocompleteListTagsResponse{id=$id, name=$name, tag=$tag, additionalProperties=$additionalProperties}"
}
