...
private constructor(
    ...
    /**
     * Date until when the recurring transaction can fire. After that date, it's basically inactive.
    ...
    companion object {
        ...
        fun none(): RecurrenceUpdateParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [RecurrenceUpdateParams]. */
        fun builder() = Builder()
    }

    /** A builder for [RecurrenceUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(recurrenceUpdateParams: RecurrenceUpdateParams) = apply {
            id = recurrenceUpdateParams.id
            xTraceId = recurrenceUpdateParams.xTraceId
            body = recurrenceUpdateParams.body.toBuilder()
            additionalHeaders = recurrenceUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = recurrenceUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Date until when the recurring transaction can fire. After that date, it's basically
         * inactive. Use either this field or repetitions.
         */
        ...
        /**
         * Returns an immutable instance of [RecurrenceUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RecurrenceUpdateParams =
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{active=$active, applyRules=$applyRules, description=$description, firstDate=$firstDate, notes=$notes, nrOfRepetitions=$nrOfRepetitions, repeatUntil=$repeatUntil, repetitions=$repetitions, title=$title, transactions=$transactions, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        ) : this(moment, skip, type, weekend, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun moment(): String? = moment.getNullable("moment")
         ...
         *   server responded with an unexpected value).
         */
        fun type(): RecurrenceRepetitionType? = type.getNullable("type")
        ...
        class Builder internal constructor() {
            ...
            private var moment: JsonField<String> = JsonMissing.of()
            private var skip: JsonField<Int> = JsonMissing.of()
            private var type: JsonField<RecurrenceRepetitionType> = JsonMissing.of()
            ...
            fun build(): Repetition =
                Repetition(moment, skip, type, weekend, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(moment, skip, type, weekend, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Repetition{moment=$moment, skip=$skip, type=$type, weekend=$weekend, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        override fun toString() =
            "Transaction{id=$id, amount=$amount, billId=$billId, budgetId=$budgetId, categoryId=$categoryId, currencyCode=$currencyCode, currencyId=$currencyId, description=$description, destinationId=$destinationId, foreignAmount=$foreignAmount, foreignCurrencyId=$foreignCurrencyId, piggyBankId=$piggyBankId, sourceId=$sourceId, tags=$tags, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecurrenceUpdateParams &&
            id == other.id &&
    ...
    override fun toString() =
        "RecurrenceUpdateParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
