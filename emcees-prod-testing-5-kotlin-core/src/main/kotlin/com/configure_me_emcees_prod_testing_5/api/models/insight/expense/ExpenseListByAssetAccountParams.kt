...
class ExpenseListByAssetAccountParams
private constructor(
    ...
    /** A builder for [ExpenseListByAssetAccountParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(expenseListByAssetAccountParams: ExpenseListByAssetAccountParams) =
            apply {
                end = expenseListByAssetAccountParams.end
                start = expenseListByAssetAccountParams.start
                accounts = expenseListByAssetAccountParams.accounts?.toMutableList()
                xTraceId = expenseListByAssetAccountParams.xTraceId
                additionalHeaders = expenseListByAssetAccountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    expenseListByAssetAccountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [ExpenseListByAssetAccountParams].
         *
         ...
         */
        fun build(): ExpenseListByAssetAccountParams =
            ExpenseListByAssetAccountParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpenseListByAssetAccountParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "ExpenseListByAssetAccountParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
