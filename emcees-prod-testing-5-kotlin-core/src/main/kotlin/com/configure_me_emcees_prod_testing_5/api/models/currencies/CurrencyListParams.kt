...
private constructor(
    ...
    companion object {
        ...
        fun none(): CurrencyListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(currencyListParams: CurrencyListParams) = apply {
            limit = currencyListParams.limit
            page = currencyListParams.page
            xTraceId = currencyListParams.xTraceId
    ...
    override fun toString() =
        "CurrencyListParams{limit=$limit, page=$page, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
