...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(transactionListParams: TransactionListParams) = apply {
            ...
            start = transactionListParams.start
            type = transactionListParams.type
            xTraceId = transactionListParams.xTraceId
    ...
    override fun toString() =
        "TransactionListParams{end=$end, limit=$limit, page=$page, start=$start, type=$type, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
