...
import com.firefly.api.models.about.UserRead
...
private constructor(
    private val data: JsonField<List<UserRead>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<UserRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<UserRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<UserRead>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<UserRead>>? = null
        ...
        internal fun from(userListResponse: UserListResponse) = apply {
            ...
            links = userListResponse.links
            meta = userListResponse.meta
            additionalProperties = userListResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<UserRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<UserRead>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<UserRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [UserRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: UserRead) = apply {
            this.data =
    ...
    override fun toString() =
        "UserListResponse{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
