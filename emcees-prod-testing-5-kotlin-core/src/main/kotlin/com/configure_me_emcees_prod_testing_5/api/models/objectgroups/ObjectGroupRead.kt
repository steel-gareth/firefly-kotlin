...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ObjectGroupRead].
         *
    ...
    class Builder internal constructor() {
        ...
        internal fun from(objectGroupRead: ObjectGroupRead) = apply {
            id = objectGroupRead.id
            attributes = objectGroupRead.attributes
            type = objectGroupRead.type
            additionalProperties = objectGroupRead.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ObjectGroupRead].
         *
     ...
     *   its expected type.
     */
    fun validate(): ObjectGroupRead = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(order, title, createdAt, updatedAt, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(order, title, createdAt, updatedAt, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Attributes{order=$order, title=$title, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ObjectGroupRead &&
            id == other.id &&
    ...
    override fun toString() =
        "ObjectGroupRead{id=$id, attributes=$attributes, type=$type, additionalProperties=$additionalProperties}"
}
