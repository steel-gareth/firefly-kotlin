...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CategoryUpdateParams].
         *
    ...
    /** A builder for [CategoryUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(categoryUpdateParams: CategoryUpdateParams) = apply {
            id = categoryUpdateParams.id
            xTraceId = categoryUpdateParams.xTraceId
            body = categoryUpdateParams.body.toBuilder()
            additionalHeaders = categoryUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = categoryUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CategoryUpdateParams].
         *
         ...
         */
        fun build(): CategoryUpdateParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("name", name), notes, additionalProperties.toMutableMap())
        }
        ...
        internal fun validity(): Int =
            (if (name.asKnown() == null) 0 else 1) + (if (notes.asKnown() == null) 0 else 1)
        ...
        private val hashCode: Int by lazy { Objects.hash(name, notes, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{name=$name, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CategoryUpdateParams &&
            id == other.id &&
    ...
    override fun toString() =
        "CategoryUpdateParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
