...
import com.configure_me_emcees_prod_testing_5.api.models.piggybanks.PiggyBankRead
...
private constructor(
    private val data: JsonField<List<PiggyBankRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PiggyBankRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PiggyBankRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PiggyBankRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PiggyBankArray].
         *
    ...
    /** A builder for [PiggyBankArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PiggyBankRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(piggyBankArray: PiggyBankArray) = apply {
            data = piggyBankArray.data.map { it.toMutableList() }
            links = piggyBankArray.links
            meta = piggyBankArray.meta
            additionalProperties = piggyBankArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<PiggyBankRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<PiggyBankRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PiggyBankRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PiggyBankRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PiggyBankRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PiggyBankArray].
         *
     ...
     *   its expected type.
     */
    fun validate(): PiggyBankArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PiggyBankArray &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "PiggyBankArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
