...
class AccountTypeFilter @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        fun of(value: String) = AccountTypeFilter(JsonField.of(value))
    }

    /** An enum containing [AccountTypeFilter]'s known values. */
    enum class Known {
        ALL,
        ASSET,
        CASH,
    ...
    /**
     * An enum containing [AccountTypeFilter]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [AccountTypeFilter] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        MORTGAGE,
        /**
         * An enum member indicating that [AccountTypeFilter] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            MORTGAGE -> Known.MORTGAGE
                ...
                throw EmceesProdTesting5InvalidDataException("Unknown AccountTypeFilter: $value")
        }
     ...
     *   its expected type.
     */
    fun validate(): AccountTypeFilter = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountTypeFilter && value == other.value
    }
