...
private constructor(
    private val data: JsonField<List<BudgetLimitRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<BudgetLimitRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<BudgetLimitRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<BudgetLimitRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [BudgetLimitArray].
         *
    ...
    /** A builder for [BudgetLimitArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<BudgetLimitRead>>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(budgetLimitArray: BudgetLimitArray) = apply {
            data = budgetLimitArray.data.map { it.toMutableList() }
            meta = budgetLimitArray.meta
            additionalProperties = budgetLimitArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<BudgetLimitRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<BudgetLimitRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<BudgetLimitRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [BudgetLimitRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: BudgetLimitRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [BudgetLimitArray].
         *
     ...
     *   its expected type.
     */
    fun validate(): BudgetLimitArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BudgetLimitArray &&
            data == other.data &&
            meta == other.meta &&
    ...
    override fun toString() =
        "BudgetLimitArray{data=$data, meta=$meta, additionalProperties=$additionalProperties}"
}
