...
/**
 * A client for interacting with the More Conflicting REST API asynchronously. You can also switch
 ...
 * may call [close].
 */
interface MoreConflictingClientAsync {
     ...
     * this client.
     */
    fun sync(): MoreConflictingClient
     ...
     */
    fun withOptions(modifier: (ClientOptions.Builder) -> Unit): MoreConflictingClientAsync
    ...
    /**
     * A view of [MoreConflictingClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
