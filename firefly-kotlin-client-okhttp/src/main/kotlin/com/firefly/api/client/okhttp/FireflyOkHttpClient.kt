...
import com.firefly.api.client.FireflyClientImpl
...
/**
 * A class that allows building an instance of [FireflyClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class FireflyOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [FireflyClient]. */
        fun builder() = Builder()
         ...
         */
        fun fromEnv(): FireflyClient = builder().fromEnv().build()
    }

    /** A builder for [FireflyOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [FireflyClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FireflyClient =
            FireflyClientImpl(
                clientOptions
                    .httpClient(
