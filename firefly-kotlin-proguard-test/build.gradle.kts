...
dependencies {
    testImplementation(project(":firefly-kotlin"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../firefly-kotlin-core/src/main/resources/META-INF/proguard/firefly-kotlin-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.firefly.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../firefly-kotlin-core/src/main/resources/META-INF/proguard/firefly-kotlin-core.pro",
