...
private constructor(
     ...
     * ```kotlin
     * val myObject: MyClass = accountUpdateParams.type().convert(MyClass::class.java)
     * ```
     */
     ...
     * proprietary value because each map provider has different zoom levels. If omitted, the
     * existing location will be kept. If submitted as NULL, the current location will be removed.
     *
     * @throws EmceesProdTesting5InvalidDataException if the JSON field has an unexpected type (e.g.
     *   if the server responded with an unexpected value).
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountUpdateParams: AccountUpdateParams) = apply {
            ...
            xTraceId = accountUpdateParams.xTraceId
        ...
        /**
         * Latitude of the account's location, if applicable. Can be used to draw a map. If omitted,
         * the existing location will be kept. If submitted as NULL, the current location will be
         * removed.
         */
         ...
         * Zoom level for the map, if drawn. This to set the box right. Unfortunately this is a
         * proprietary value because each map provider has different zoom levels. If omitted, the
         * existing location will be kept. If submitted as NULL, the current location will be
         * removed.
         */
    ...
    private constructor(
         ...
         * This arbitrary value can be deserialized into a custom type using the `convert` method:
         * ```kotlin
         * val myObject: MyClass = body.type().convert(MyClass::class.java)
         * ```
         */
        ...
        class Builder internal constructor() {
            ...
            /**
             * Zoom level for the map, if drawn. This to set the box right. Unfortunately this is a
             * proprietary value because each map provider has different zoom levels. If omitted,
             * the existing location will be kept. If submitted as NULL, the current location will
             * be removed.
             */
    ...
    override fun toString() =
        "AccountUpdateParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
