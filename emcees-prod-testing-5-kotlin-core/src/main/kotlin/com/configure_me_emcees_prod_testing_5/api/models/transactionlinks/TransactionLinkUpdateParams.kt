...
class TransactionLinkUpdateParams
private constructor(
    ...
    companion object {
        ...
        fun none(): TransactionLinkUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TransactionLinkUpdateParams].
         */
        fun builder() = Builder()
    }

    /** A builder for [TransactionLinkUpdateParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(transactionLinkUpdateParams: TransactionLinkUpdateParams) = apply {
            id = transactionLinkUpdateParams.id
            xTraceId = transactionLinkUpdateParams.xTraceId
            body = transactionLinkUpdateParams.body.toBuilder()
            additionalHeaders = transactionLinkUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = transactionLinkUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionLinkUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransactionLinkUpdateParams =
    ...
    private constructor(
        ...
        ) : this(inwardId, linkTypeId, linkTypeName, notes, outwardId, mutableMapOf())
         ...
         */
        fun inwardId(): String? = inwardId.getNullable("inward_id")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun linkTypeId(): String? = linkTypeId.getNullable("link_type_id")
         ...
         *   (e.g. if the server responded with an unexpected value).
         */
        fun outwardId(): String? = outwardId.getNullable("outward_id")
        ...
        class Builder internal constructor() {
            ...
            private var inwardId: JsonField<String> = JsonMissing.of()
            private var linkTypeId: JsonField<String> = JsonMissing.of()
            private var linkTypeName: JsonField<String> = JsonMissing.of()
            private var notes: JsonField<String> = JsonMissing.of()
            private var outwardId: JsonField<String> = JsonMissing.of()
        ...
        private val hashCode: Int by lazy {
            Objects.hash(inwardId, linkTypeId, linkTypeName, notes, outwardId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{inwardId=$inwardId, linkTypeId=$linkTypeId, linkTypeName=$linkTypeName, notes=$notes, outwardId=$outwardId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionLinkUpdateParams &&
            id == other.id &&
    ...
    override fun toString() =
        "TransactionLinkUpdateParams{id=$id, xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
