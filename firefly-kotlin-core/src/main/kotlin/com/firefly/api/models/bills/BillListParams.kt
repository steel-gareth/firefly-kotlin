...
private constructor(
    ...
    companion object {
        ...
        fun none(): BillListParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(billListParams: BillListParams) = apply {
            end = billListParams.end
            limit = billListParams.limit
            page = billListParams.page
            start = billListParams.start
            xTraceId = billListParams.xTraceId
    ...
    override fun toString() =
        "BillListParams{end=$end, limit=$limit, page=$page, start=$start, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
