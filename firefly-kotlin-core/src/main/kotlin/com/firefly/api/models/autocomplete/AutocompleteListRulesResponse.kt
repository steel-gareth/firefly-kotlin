...
class AutocompleteListRulesResponse
...
private constructor(
    ...
    /** A builder for [AutocompleteListRulesResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(autocompleteListRulesResponse: AutocompleteListRulesResponse) = apply {
            id = autocompleteListRulesResponse.id
            name = autocompleteListRulesResponse.name
            active = autocompleteListRulesResponse.active
            description = autocompleteListRulesResponse.description
            additionalProperties = autocompleteListRulesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListRulesResponse].
         *
         ...
         */
        fun build(): AutocompleteListRulesResponse =
            AutocompleteListRulesResponse(
                checkRequired("id", id),
     ...
     *   expected type.
     */
    fun validate(): AutocompleteListRulesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListRulesResponse &&
            id == other.id &&
            name == other.name &&
            active == other.active &&
    ...
    override fun toString() =
        "AutocompleteListRulesResponse{id=$id, name=$name, active=$active, description=$description, additionalProperties=$additionalProperties}"
}
