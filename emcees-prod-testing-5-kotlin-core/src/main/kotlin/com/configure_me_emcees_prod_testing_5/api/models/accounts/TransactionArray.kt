...
import com.configure_me_emcees_prod_testing_5.api.models.transactionjournals.TransactionRead
...
private constructor(
    private val data: JsonField<List<TransactionRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<TransactionRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<TransactionRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<TransactionRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionArray].
         *
    ...
    /** A builder for [TransactionArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<TransactionRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(transactionArray: TransactionArray) = apply {
            data = transactionArray.data.map { it.toMutableList() }
            links = transactionArray.links
            meta = transactionArray.meta
            additionalProperties = transactionArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<TransactionRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TransactionRead>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<TransactionRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TransactionRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TransactionRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [TransactionArray].
         *
     ...
     *   its expected type.
     */
    fun validate(): TransactionArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionArray &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "TransactionArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
