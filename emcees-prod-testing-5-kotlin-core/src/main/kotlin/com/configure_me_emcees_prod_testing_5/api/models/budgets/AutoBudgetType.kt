...
class AutoBudgetType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        fun of(value: String) = AutoBudgetType(JsonField.of(value))
    }

    /** An enum containing [AutoBudgetType]'s known values. */
    enum class Known {
        RESET,
        ROLLOVER,
        NONE,
    ...
    /**
     * An enum containing [AutoBudgetType]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [AutoBudgetType] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        NONE,
        /**
         * An enum member indicating that [AutoBudgetType] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
    ...
    fun known(): Known =
        when (this) {
            ...
            NONE -> Known.NONE
            else -> throw EmceesProdTesting5InvalidDataException("Unknown AutoBudgetType: $value")
        }
     ...
     *   its expected type.
     */
    fun validate(): AutoBudgetType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutoBudgetType && value == other.value
    }
