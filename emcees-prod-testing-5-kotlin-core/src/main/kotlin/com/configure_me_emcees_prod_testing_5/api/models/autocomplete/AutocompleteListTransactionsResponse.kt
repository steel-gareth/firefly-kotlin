...
class AutocompleteListTransactionsResponse
...
private constructor(
    ...
    /** A builder for [AutocompleteListTransactionsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = autocompleteListTransactionsResponse.id
            description = autocompleteListTransactionsResponse.description
            name = autocompleteListTransactionsResponse.name
            transactionGroupId = autocompleteListTransactionsResponse.transactionGroupId
            additionalProperties =
                autocompleteListTransactionsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AutocompleteListTransactionsResponse].
         *
         ...
         */
        fun build(): AutocompleteListTransactionsResponse =
            AutocompleteListTransactionsResponse(
                checkRequired("id", id),
     ...
     *   its expected type.
     */
    fun validate(): AutocompleteListTransactionsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AutocompleteListTransactionsResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "AutocompleteListTransactionsResponse{id=$id, description=$description, name=$name, transactionGroupId=$transactionGroupId, additionalProperties=$additionalProperties}"
}
