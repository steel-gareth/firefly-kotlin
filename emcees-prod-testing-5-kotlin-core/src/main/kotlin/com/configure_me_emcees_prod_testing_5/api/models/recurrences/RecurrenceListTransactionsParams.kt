 ...
 * specified.
 */
class RecurrenceListTransactionsParams
private constructor(
    ...
    companion object {
        ...
        fun none(): RecurrenceListTransactionsParams = builder().build()
    ...
    /** A builder for [RecurrenceListTransactionsParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(recurrenceListTransactionsParams: RecurrenceListTransactionsParams) =
            apply {
                id = recurrenceListTransactionsParams.id
                end = recurrenceListTransactionsParams.end
                limit = recurrenceListTransactionsParams.limit
                page = recurrenceListTransactionsParams.page
                start = recurrenceListTransactionsParams.start
                type = recurrenceListTransactionsParams.type
                xTraceId = recurrenceListTransactionsParams.xTraceId
                additionalHeaders = recurrenceListTransactionsParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    recurrenceListTransactionsParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [RecurrenceListTransactionsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): RecurrenceListTransactionsParams =
            RecurrenceListTransactionsParams(
                id,
                end,
                limit,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is RecurrenceListTransactionsParams &&
            id == other.id &&
            end == other.end &&
            limit == other.limit &&
            page == other.page &&
    ...
    override fun toString() =
        "RecurrenceListTransactionsParams{id=$id, end=$end, limit=$limit, page=$page, start=$start, type=$type, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
