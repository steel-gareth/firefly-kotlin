...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LimitList1Params].
         *
    ...
    /** A builder for [LimitList1Params]. */
    class Builder internal constructor() {
        ...
        internal fun from(limitList1Params: LimitList1Params) = apply {
            end = limitList1Params.end
            start = limitList1Params.start
            xTraceId = limitList1Params.xTraceId
            additionalHeaders = limitList1Params.additionalHeaders.toBuilder()
            additionalQueryParams = limitList1Params.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LimitList1Params].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LimitList1Params &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "LimitList1Params{end=$end, start=$start, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
