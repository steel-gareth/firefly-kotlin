...
import com.configure_me_emcees_prod_testing_5.api.errors.MoreConflictingException
...
internal class ErrorHandlingTest {
    ...
    private lateinit var client: MoreConflictingClient

    @BeforeEach
    fun beforeEach(wmRuntimeInfo: WireMockRuntimeInfo) {
        client =
            MoreConflictingOkHttpClient.builder()
    ...
    fun storeListInventoryInvalidJsonBody() {
        ...
        val e = assertThrows<MoreConflictingException> { storeService.listInventory() }
