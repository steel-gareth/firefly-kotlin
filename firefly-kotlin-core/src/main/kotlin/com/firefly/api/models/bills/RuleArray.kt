...
import com.firefly.api.models.rules.RuleRead
...
private constructor(
    private val data: JsonField<List<RuleRead>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<RuleRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<RuleRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<RuleRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [RuleArray].
         *
    ...
    /** A builder for [RuleArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<RuleRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(ruleArray: RuleArray) = apply {
            data = ruleArray.data.map { it.toMutableList() }
            links = ruleArray.links
            meta = ruleArray.meta
            additionalProperties = ruleArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<RuleRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<RuleRead>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<RuleRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [RuleRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: RuleRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [RuleArray].
         *
    ...
    override fun toString() =
        "RuleArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
