...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(budgetCreateParams: BudgetCreateParams) = apply {
            xTraceId = budgetCreateParams.xTraceId
            body = budgetCreateParams.body.toBuilder()
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{name=$name, active=$active, autoBudgetAmount=$autoBudgetAmount, autoBudgetCurrencyCode=$autoBudgetCurrencyCode, autoBudgetCurrencyId=$autoBudgetCurrencyId, autoBudgetPeriod=$autoBudgetPeriod, autoBudgetType=$autoBudgetType, fireWebhooks=$fireWebhooks, notes=$notes, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "BudgetCreateParams{xTraceId=$xTraceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
