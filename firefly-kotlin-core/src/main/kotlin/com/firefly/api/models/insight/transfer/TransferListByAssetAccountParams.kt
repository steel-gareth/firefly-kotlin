 ...
 * lability.
 */
class TransferListByAssetAccountParams
private constructor(
    ...
    /** A builder for [TransferListByAssetAccountParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(transferListByAssetAccountParams: TransferListByAssetAccountParams) =
            apply {
                end = transferListByAssetAccountParams.end
                start = transferListByAssetAccountParams.start
                accounts = transferListByAssetAccountParams.accounts?.toMutableList()
                xTraceId = transferListByAssetAccountParams.xTraceId
                additionalHeaders = transferListByAssetAccountParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    transferListByAssetAccountParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [TransferListByAssetAccountParams].
         *
         ...
         */
        fun build(): TransferListByAssetAccountParams =
            TransferListByAssetAccountParams(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransferListByAssetAccountParams &&
            end == other.end &&
            start == other.start &&
    ...
    override fun toString() =
        "TransferListByAssetAccountParams{end=$end, start=$start, accounts=$accounts, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
