...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.firefly.api.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.firefly.api.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.firefly.api.** {
    <init>(...);
