...
private constructor(private val value: JsonField<String>) : Enum {
    ...
    companion object {
        ...
        val OPENING_BALANCE = of("opening balance")

        fun of(value: String) = TransactionTypeProperty(JsonField.of(value))
    }

    /** An enum containing [TransactionTypeProperty]'s known values. */
    enum class Known {
        WITHDRAWAL,
        DEPOSIT,
        TRANSFER,
    ...
    /**
     * An enum containing [TransactionTypeProperty]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [TransactionTypeProperty] can contain an unknown value in a couple of cases:
    ...
    enum class Value {
        ...
        OPENING_BALANCE,
        /**
         * An enum member indicating that [TransactionTypeProperty] was instantiated with an unknown
         * value.
         */
        _UNKNOWN,
    }
        ...
        when (this) {
            ...
            OPENING_BALANCE -> Known.OPENING_BALANCE
                ...
                throw EmceesProdTesting5InvalidDataException(
                    "Unknown TransactionTypeProperty: $value"
                )
        }
     ...
     *   its expected type.
     */
    fun validate(): TransactionTypeProperty = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionTypeProperty && value == other.value
    }
