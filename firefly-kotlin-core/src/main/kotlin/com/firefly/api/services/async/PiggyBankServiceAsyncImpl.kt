 ...
 * information.
 */
class PiggyBankServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    PiggyBankServiceAsync {

    private val withRawResponse: PiggyBankServiceAsync.WithRawResponse by lazy {
        WithRawResponseImpl(clientOptions)
    }

    override fun withRawResponse(): PiggyBankServiceAsync.WithRawResponse = withRawResponse

    override fun withOptions(modifier: (ClientOptions.Builder) -> Unit): PiggyBankServiceAsync =
        PiggyBankServiceAsyncImpl(clientOptions.toBuilder().apply(modifier).build())
    ...
    override suspend fun delete(params: PiggyBankDeleteParams, requestOptions: RequestOptions) {
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        override fun withOptions(
            ...
            PiggyBankServiceAsyncImpl.WithRawResponseImpl(
