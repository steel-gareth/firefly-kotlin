...
private constructor(
    private val data: JsonField<List<WebhookMessage>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<WebhookMessage>> = JsonMissing.of(),
     ...
     */
    fun data(): List<WebhookMessage> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<WebhookMessage>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<WebhookMessage>>? = null
        ...
        fun data(data: List<WebhookMessage>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<WebhookMessage>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<WebhookMessage>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [WebhookMessage] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: WebhookMessage) = apply {
            this.data =
