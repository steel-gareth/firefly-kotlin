...
import com.configure_me_emcees_prod_testing_5.api.core.http.HttpRequestBody
import com.configure_me_emcees_prod_testing_5.api.core.http.HttpResponse
import com.configure_me_emcees_prod_testing_5.api.core.http.ProxyAuthenticator
import com.configure_me_emcees_prod_testing_5.api.errors.EmceesProdTesting5IoException
...
class OkHttpClient internal constructor(private val okHttpClient: okhttp3.OkHttpClient) :
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw EmceesProdTesting5IoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
