...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(categoryRetrieveParams: CategoryRetrieveParams) = apply {
            id = categoryRetrieveParams.id
            end = categoryRetrieveParams.end
            start = categoryRetrieveParams.start
            xTraceId = categoryRetrieveParams.xTraceId
    ...
    override fun toString() =
        "CategoryRetrieveParams{id=$id, end=$end, start=$start, xTraceId=$xTraceId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
