...
private constructor(
    private val data: JsonField<List<TransactionLinkRead>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<TransactionLinkRead>> = JsonMissing.of(),
     ...
     */
    fun data(): List<TransactionLinkRead> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<TransactionLinkRead>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionLinkArray].
         *
    ...
    /** A builder for [TransactionLinkArray]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<TransactionLinkRead>>? = null
        private var links: JsonField<PageLink>? = null
        private var meta: JsonField<Meta>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        internal fun from(transactionLinkArray: TransactionLinkArray) = apply {
            data = transactionLinkArray.data.map { it.toMutableList() }
            links = transactionLinkArray.links
            meta = transactionLinkArray.meta
            additionalProperties = transactionLinkArray.additionalProperties.toMutableMap()
        }

        fun data(data: List<TransactionLinkRead>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<TransactionLinkRead>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<TransactionLinkRead>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TransactionLinkRead] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TransactionLinkRead) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [TransactionLinkArray].
         *
         ...
         */
        fun build(): TransactionLinkArray =
     ...
     *   its expected type.
     */
    fun validate(): TransactionLinkArray = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TransactionLinkArray &&
            data == other.data &&
            links == other.links &&
            meta == other.meta &&
    ...
    override fun toString() =
        "TransactionLinkArray{data=$data, links=$links, meta=$meta, additionalProperties=$additionalProperties}"
}
